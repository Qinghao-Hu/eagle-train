...
data = torch.load("/nobackup/qinghao/runs/eagle/eagle-data/Eagle-Mix-Llama-3.1-8B-Instruct/data_88811.pt")


tokenizer = AutoTokenizer.from_pretrained("/nobackup/model/llama3.1/Llama-3.1-8B-Instruct", trust_remote_code=True)
data_input = data["input_ids"]
text = tokenizer.decode(data_input)

print(data["loss_mask"])
# print(text)
