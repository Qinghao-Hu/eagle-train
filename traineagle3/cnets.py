...
class Model(nn.Module):
    ...
    def scandata(self, datapath, tokenizerpath):
        ...
        if not os.path.exists("/home/qinghao/workdir/eagle-train/freq_map/llama3/freq_32768.pt"):
            ...
            cache = torch.load("/home/qinghao/workdir/eagle-train/freq_map/llama3/freq_32768.pt")
            d2t = cache["d2t"]
            t2d = cache["t2d"]
