...
from transformers import AutoModelForCausalLM, AutoTokenizer, PreTrainedTokenizerBase, get_linear_schedule_with_warmup

parser = argparse.ArgumentParser(description='sp')
parser.add_argument("--basepath", type=str, default="/nobackup/model/llama3.1/Llama-3.1-8B-Instruct")
parser.add_argument("--trainpath", type=str, default="/nobackup/qinghao/trace/ShareGPT_V4.3_unfiltered_cleaned_split.json")
parser.add_argument("--testpath", type=str, default="/nobackup/qinghao/trace/ShareGPT_V4.3_unfiltered_cleaned_split.json")
parser.add_argument("--savedir", type=str, default="test_train")
...
if global_rank == 0:
    ...
    wandb.init(project="Eagle3-Official", name="llama-ShareGPT", config=ds_config)
